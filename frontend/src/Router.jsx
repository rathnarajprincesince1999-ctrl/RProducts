...
import AdminShipping from './feature/auth/pages/AdminShipping';
...
import SellerShipping from './feature/auth/pages/SellerShipping';
...
import UserOrders from './feature/auth/pages/UserOrders';
import UserReturns from './feature/auth/pages/UserReturns';
import UserProfile from './feature/auth/pages/UserProfile';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/seller/home" element={<ProtectedRoute requiredRole="seller"><SellerHome /></ProtectedRoute>} />
        ...
        <Route path="/seller/shipping" element={<ProtectedRoute requiredRole="seller"><SellerShipping /></ProtectedRoute>} />
